package com.nathanmod.tutorialmod.item.custom;
...
public class MobSpawnEggItem extends SpawnEggItem {
    // adding eggs everytime we register an egg
    protected static final List<MobSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public MobSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
    ...
    public static void initSpawnEggs() {
        ...
        DefaultDispenseItemBehavior dispenseItemBehavior = new DefaultDispenseItemBehavior() {
            @Override //spawns egg when in dispenser
